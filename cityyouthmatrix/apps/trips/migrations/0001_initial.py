# Generated by Django 3.0.7 on 2020-06-24 02:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_address', smart_selects.db_fields.ChainedForeignKey(chained_field='family', chained_model_field='family', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='accounts.FamilyAddress')),
                ...
                ('return_address', smart_selects.db_fields.ChainedForeignKey(chained_field='family', chained_model_field='family', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='accounts.FamilyAddress')),
